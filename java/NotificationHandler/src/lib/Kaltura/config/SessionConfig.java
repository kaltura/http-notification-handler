...
public class SessionConfig {
	...
	public static final int KALTURA_PARTNER_ID = -1;
	/** The secret of the indicated partner */
	public static final String KALTURA_ADMIN_SECRET = "ADMIN_SECRET";
	/** Kaltura service url - the end point*/
	public static final String KALTURA_SERVICE_URL = "SERVICE_URL";
